...
public class OurDumbBehavior extends TickerBehaviour {
	...
	public OurDumbBehavior(Agent a, long period) {
		super(a, period);
	...
	protected void onTick() {
		...
		ArrayList<Tuple2<Vector3f, String>> enemies = agent.getVisibleAgents(AbstractAgent.VISION_DISTANCE,
